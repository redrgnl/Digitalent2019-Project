...
//query jumlah anggota yang terdaftar / ter approve
$querynums = mysqli_query($mysqli, "SELECT * FROM tbl_mapping");
$anggotanums = mysqli_num_rows($querynums);

//query melihat jumlah anggota perbulan dalam tahun ini
...
//query menampilkan jumlah anggota terdaftar berdasarkan provinsi
...
<head>
  ...
  <title>AWDI | Ketua | Dashboard</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="kta_dashboard.php"><i class="fa fa-circle-o"></i> Statistik</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="callout callout-success">
            <h4>Jumlah Anggota | Anggota Per Provinsi</h4>
            <p>Asosiasi Web Developer Indonesia</p>
          </div>
        </div>
      </div>
      <!-- end row jumlah total anggota -->
      <div class="row">
        <div class="col-md-6">
      ...
      <div class="row">
        <div class="col-md-6">
          <h4>Jumlah Anggota Per Provinsi</h4>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <div class="box box-solid box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Daftar Anggota Per Provinsi</h3>
            </div>
            <div class="box-body">
