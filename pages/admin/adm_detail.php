...
//mengambil data anggota spesifik nik
$querybio = mysqli_query($mysqli, "SELECT * FROM tbl_anggota WHERE nik = '$nik'");
...
//memanggil data portofolio anggota spesifik nik
$queryporto = mysqli_query($mysqli, "SELECT * FROM tbl_portopolio WHERE nik = '$nik'");
$numporto = mysqli_num_rows($queryporto);

//kondisi jika portopolio belum terisi / masih kososng
if ($numporto != 0) {
...
//query melihat posisi anggota
$queryposisi = mysqli_query($mysqli, "SELECT tbl_posisi.nama_posisi FROM tbl_posisi, tbl_mapping WHERE tbl_mapping.nik = '$nik' AND tbl_mapping.id_posisi = tbl_posisi.id_posisi");
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active" class="active"><a href="adm_dashboard.php"><i class="fa fa-circle-o"></i> Dashboard</a></li>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="box box-success box-solid">
            <div class="box-header with-border">
              ...
              <div class="pull-right">
                <a href="adm_privilege.php?nik=<?php echo $nik?>" class="btn btn-danger">Update Akses</a>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <div class="col-md-9">
          <div class="callout callout-success">
            <h4>Detail Portopolio Anggota</h4>
          ...
          <div class="box box-success box-solid">
            <div class="box-header with-border">
              ...
              <div class="pull-right">
                <a href="adm_porto.php?nik=<?php echo $nik?>" class="btn btn-danger">Update Portopolio</a>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
