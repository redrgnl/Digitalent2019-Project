...
//query menampilkan biodata anggota spesifik nik
...
//query menampilkan jabatan anggota berdasarkan nik
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="callout callout-success">
            <h4>Detail Anggota | Portopolio Anggota</h4>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="box box-success box-solid">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <strong><i class="fa fa-qrcode margin-r-5"></i> Jabatan</strong>
